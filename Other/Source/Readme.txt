DEVELOPER: Replace the three occurrences of MeldPortable in this file
...
user in an INI file next to MeldPortable.exe called MeldPortable.ini.
...
copy AppNamePortable.ini from this directory to MeldPortable.ini next to
MeldPortable.exe. The options in the INI file are as follows:
